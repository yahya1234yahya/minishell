...
execution/hdoc.c parsing/split_pipe.c execution/exit.c execution/unset.c parsing/parsing_helper.c parsing/parsing_helper2.c \
execution/tools/gcollector.c execution/tools/minilibft2.c execution/tools/minilibft3.c execution/tools/minilibft4.c \
execution/executemulti.c execution/executesingle.c
...
all: $(NAME)
%.o: %.c $(HEADER)
	$(CC) -c $< -o $@ -I $(READLINEDIR)/include -g3
$(NAME): $(OBJS)
	$(CC)   $(OBJS) -o $(NAME) -L $(READLINEDIR)/lib -lreadline -lhistory  -g3
clean:
	rm -f $(OBJS)
fclean: clean
	rm -f $(NAME)
