...
execution/nbuilt3.c parsing/ft_random.c
...
all: $(NAME)
%.o: %.c $(HEADER)
	$(CC) $(FLAGS) -c $< -o $@ -I $(READLINEDIR)/include -g -fsanitize=address
$(NAME): $(OBJS)
	$(CC) $(FLAGS) $(OBJS) -o $(NAME) -L $(READLINEDIR)/lib -lreadline -lhistory -g -fsanitize=address
	# rm -f $(OBJS)
fclean: clean
	rm -f $(NAME)
clean:
